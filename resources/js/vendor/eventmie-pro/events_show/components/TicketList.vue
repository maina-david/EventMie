                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" v-if="bookedTicketsTotal() > 0 && login_user_id">
                                ...
                                <div class="d-block my-3 pl-3" v-else>
                                    ...
                                    <div class="radio-inline" v-if="is_admin <= 0 && is_tiny_pesa > 0">
                                        <input type="radio" class="custom-control-input" id="payment_method_tinypesa" name="payment_method" v-model="payment_method" value="2" >
                                        <label class="custom-control-label" for="payment_method_tinypesa"> &nbsp;<i class="fab fa-paypal"></i> TinyPesa</label>
                                    </div>
