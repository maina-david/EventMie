                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="text-center">
                            <h3 class="title ticket-selected-text mb-4">
                                {{ trans("em.checkout") }}
                            </h3>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <input
                            ...
                            :value="
                                ...
                                typeof booking_end_date != 'undefined'
                                    ? serverTimezone(
                                          booking_end_date + ' ' + end_time,
                                          'dddd LL HH:mm a'
                                      ).format('YYYY-MM-DD')
                                    : null
                            "
                        ...
                        <div
                            class="row"
                            v-if="payment_method == 2 && is_tiny_pesa > 0"
                        >
                            <div class="col-md-12 mb-5">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        v-model="phone"
                                        v-validate="'required'"
                                        :placeholder="trans('em.phone_info')"
                                    />
                                    <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-5" v-if="is_customer <= 0">
                                <div class="col-md-5">
                                    ...
                                    <v-select
                                        ...
                                        class="style-chooser"
                                        :placeholder="
                                            trans('em.search_customer_email')
                                        "
                                        v-model="customer"
                                        :required="!customer"
                                        :filterable="false"
                            ...
                            <!-- Booking Info -->
                            <div class="col-md-12">
                                <p class="mb-0 lead lead-caption text-center">
                                    {{ trans("em.booking_info") }}
                                </p>

                                <ul class="list-group m-0">
                                    <li
                                        class="list-group-item d-flex justify-content-between lh-condensed d-flex-wrap"
                                    >
                                        <div>
                                            <h6 class="my-0">
                                                <strong>{{
                                                    trans("em.event_category")
                                                }}</strong>
                                            </h6>
                                            <p class="mb-2">
                                                {{ event.title }}
                                ...
                                <ul class="list-group m-0">
                                    ...
                                    >
                                        ...
                                        <div class="w-30 text-right">
                                            ...
                                            <p v-if="quantity[index] > 0">
                                                <i
                                                    class="fas fa-check-circle ticket-selected-text"
                                                ></i>
                                            </p>
                                        </div>
                            ...
                            <!-- Cart Totals -->
                            <div class="col-md-12">
                                <p class="m-0 lead lead-caption text-center">
                                    {{ trans("em.cart") }}
                                </p>
                                ...
                                <ul class="list-group m-0">
                                    ...
                                    >
                                        <h6 class="my-0">
                                            <strong>{{
                                                trans("em.total_tickets")
                                            }}</strong>
                                        </h6>
                                        <strong
                                            :class="{
                                                'ticket-selected-text':
                                                    bookedTicketsTotal() > 0,
                                            }"
                                            >{{ bookedTicketsTotal() }}</strong
                                        >
                                    </li>
                                    <li
                                        class="list-group-item d-flex justify-content-between"
                            ...
                            <div
                                class="col-md-12"
                                v-if="bookedTicketsTotal() > 0 && login_user_id"
                            >
                                <p class="m-0 lead lead-caption text-center">
                                    {{ trans("em.payment") }}
                                </p>
                                ...
                                <div class="d-block my-3 pl-3" v-else>
                                    ...
                                    <div
                                        class="radio-inline"
                                        v-if="is_admin <= 0 && is_tiny_pesa > 0"
                                    >
                                        <input
                                            type="radio"
                                            class="custom-control-input"
                                            id="payment_method_tinypesa"
                                            name="payment_method"
                                            v-model="payment_method"
                                            value="2"
                                        />
                                    ...
                                    <p
                                        v-if="payment_method == 'offline'"
                                        class="text-info"
                                    >
                                        <strong
                                            >{{
                                                trans(
                                                    "em.offline_payment_info"
                                                )
                                            }}: </strong
                                        ><small
                                            v-html="event.offline_payment_info"
                                        ></small>
                                    </p>

                                    <p
                                        class="text-mute mt-5"
                                        v-html="trans('em.order_terms')"
                                    ></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-xs-12" v-else>
                                <div class="btn-group btn-group-justified">
                                    ...
                                    <button
                                        type="button"
                                        class="btn lgx-btn lgx-btn-black w-50"
                                        @click="loginFirst()"
                                    >
    ...
    methods: {
        ...
        countTax(price, tax, rate_type, net_price, quantity) {
            ...
            if (rate_type == "percent") {
                if (isNaN((price * total_tax) / 100)) return 0;
            ...
            if (this.quantity != null || this.quantity.length > 0) {
                ...
                this.quantity.forEach(
                    function (value, key) {
                        ...
                        this.total_price[key] = (
                            parseFloat(amount) + parseFloat(total_tax)
                        ).toFixed(2);
                    }.bind(this)
                );
            }
        ...
        setDefaultQuantity() {
            ...
            var promise = new Promise(function (resolve, reject) {
                ...
                if (_this.quantity.length == 1) {
                    _this.tickets.forEach(
                        function (value, key) {
                            if (key == 0) _this.quantity[key] = 0;
                            else _this.quantity[key] = 0;
                        }.bind()
                    );
                }
                resolve(true);
        ...
        orderTotal() {
            ...
            if (Object.keys(this.total_price).length > 0) {
                this.total_price.forEach(
                    function (value, key) {
                        this.total = (
                            parseFloat(this.total) + parseFloat(value)
                        ).toFixed(2);
                    }.bind(this)
                );
        ...
        search: _.debounce((loading, search, vm) => {
            if (vm.validateEmail(search)) vm.getCustomers(loading, search);
            else loading(false);
        }, 350),
