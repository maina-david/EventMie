...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$setting->exists) {
            $setting->fill(["display_name"=> "Extra Footer Credits", "value"=> "Eventmie Pro <strong>v1.8<strong>. Product by <a href='https://www.classiebit.com' target='_blank'>Classiebit</a>", "details"=> null, "type"=> "text", "order"=> "2", "group"=> "Site", ])->save();
        }
